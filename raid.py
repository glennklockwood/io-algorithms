...
if __name__ == "__main__":
    stripe = Raid5Stripe(width=3)
    print "                     parity is {:08b}".format(stripe.parity)
    for block_id, contents in enumerate([0b11010111, 0b00100100, 0b01101110]):
    ...
    for missing in range(stripe.width):
        print "calculated: {:08b}".format(stripe.calculate_block(missing))
